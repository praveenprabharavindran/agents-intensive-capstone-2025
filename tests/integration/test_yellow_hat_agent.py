...
# ----------------------------------------------------------------------
from agents_intensive_capstone.agents.yellow_hat_agent import YellowHatAgent
...
def test_fallback_prompt_when_file_missing(tmp_path: Path):
    ...
    assert "You are the Yellow Hat in the Six Thinking Hats framework" in agent.instruction